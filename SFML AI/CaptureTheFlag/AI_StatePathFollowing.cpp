...
AI_StatePathFollowing::AI_StatePathFollowing()
{
...
void AI_StatePathFollowing::Enter()
{
	sBehavior.SetBehavior(BEHAVIOR::PATH_FOLLOWING);
}

AI_STATE_TYPE AI_StatePathFollowing::Update(AI* _agent)
{
...
void AI_StatePathFollowing::Exit()
{
}
